    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-8 flex flex-col gap-8">
        ...
        <div className="space-y-3">
          <h2 className="text-xs font-bold tracking-widest text-gray-400 uppercase">मुख्य स्टोरी</h2>
        ...
        <div className="space-y-3">
          <h2 className="text-xs font-bold tracking-widest text-gray-400 uppercase">ताजा समाचार</h2>
  ...
  const renderFeaturedLayout = () => (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-5 flex flex-col gap-4">
        <div className="mb-4">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{'थप समाचार'}</h3>
        </div>
        {articles.slice(1, 5).map((article) => (
