...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "Public API for News Portal - enabling frontend developers to integrate articles, categories, ads, and more.",
      contact: {
        name: "API Support",
    ...
    paths: {
        ...
        get: {
          ...
          parameters: [
            ...
            },
            {
              ...
              schema: {
                type: "string",
                enum: ["publishedAt", "viewCount", "titleEn"],
              },
      ...
      "/api/categories": {
        get: {
          ...
          description:
            "Retrieve a list of all active categories with their subcategories and article counts",
          responses: {
            200: {
      ...
      "/api/ads": {
        get: {
          ...
          description:
            "Retrieve a list of active ads, optionally filtered by position",
          parameters: [
            {
              name: "position",
              in: "query",
      ...
      "/api/bookmarks": {
        get: {
          ...
          description:
            "Retrieve authenticated user bookmarks (requires authentication)",
          security: [{ bearerAuth: [] }],
          responses: {
            200: {
