...
const articles = [
  {
    ...
    excerptEn: "The government has shortened the workweek to five days as fuel shortages worsen due to the US-Israel conflict with Iran.",
    excerptNe: "इरान युद्धको प्रभावले इन्धन अभाव बढेपछि सरकारले कार्यालय र विद्यालयलाई शनिबार-आइतबार बिदा दिएको छ।",
    ...
    metaDescription: "Nepal introduces Saturday-Sunday weekends for government offices and schools to conserve fuel amid Iran war fallout. Tourism and economy face new challenges.",
  ...
  },
  {
    ...
    titleNe: "प्रधानमन्त्री बालेनले काठमाडौँमा कूटनीतिज्ञहरूसँग सामूहिक बैठक गर्नुभयो",
    excerptEn: "Nepal's youngest Prime Minister shared the new government's priorities with diplomatic missions stationed in Kathmandu.",
    excerptNe: "नेपालका सबैभन्दा कान्छा प्रधानमन्त्री बालendra शाहले काठमाडौँस्थित कूटनीतिक नियोगहरूलाई सरकारको प्राथमिकता बारे जानकारी दिनुभयो।",
    ...
    metaDescription: "Prime Minister Balendra Shah briefs foreign ambassadors on Nepal's stability, investment opportunities and balanced foreign policy.",
  ...
  {
    titleEn: "Arrest Warrant Issued Against Former PM Sher Bahadur Deuba and Wife",
    titleNe: "पूर्वप्रधानमन्त्री देउवा र पत्नीविरुद्ध पक्राउ पुर्जी जारी",
    excerptEn: "The couple faces investigation over illegal assets; they are currently abroad.",
    excerptNe: "अवैध सम्पत्ति आर्जन मुद्दामा काठमाडौँ जिल्ला अदालतले पूर्वप्रधानमन्त्री शेरबहादुर देउवा र डा. आरजु राणाविरुद्ध पक्राउ पुर्जी जारी गरेको छ।",
    ...
    metaDescription: "Kathmandu District Court issues arrest warrant against former Prime Minister Sher Bahadur Deuba and wife Arzu Rana in money laundering case.",
    categoryId: CATEGORIES.politics,
    tagIds: [TAGS.government, TAGS.nepal],
    isBreaking: true,
    isFeatured: false,
  },
  {
    ...
    excerptEn: "Demonstrators demand government action as fuel costs soar due to the Iran conflict.",
    excerptNe: "इरान द्वन्द्वका कारण इन्धन मूल्य बढेपछि युवा कार्यकर्ताहरूले काठमाडौँमा विरोध प्रदर्शन गरेका छन्।",
    ...
    metaDescription: "Youth activists stage protests in Kathmandu against sharp rise in fuel prices triggered by global crisis.",
  ...
  },
  {
    ...
    excerptEn: "Health Minister inspects facilities and urges citizens to enrol in the scheme.",
    excerptNe: "स्वास्थ्य मन्त्रीले सुन्सरी जिल्ला अस्पतालको निरीक्षण गर्दै नागरिकलाई बीमा योजनामा सहभागी हुन आह्वान गर्नुभएको छ।",
    ...
    metaDescription: "Government and health stakeholders mark 10th National Health Insurance Day with calls for wider coverage and better services.",
    categoryId: CATEGORIES.society,
  ...
  },
  {
    ...
    excerptEn: "Western parts may receive heavy rainfall while the rest of the country sees light to moderate showers.",
    excerptNe: "पश्चिमी क्षेत्रमा भारी वर्षा र बाँकी भागमा हल्कादेखि मध्यम वर्षाको पूर्वानुमान गरिएको छ।",
    ...
    metaDescription: "Meteorological Department forecasts rain and heavy showers in western regions; caution issued for landslides and floods.",
  ...
  },
  {
    ...
    excerptEn: "Airlines have increased domestic and international fares following sharp hike in aviation fuel prices.",
    excerptNe: "हवाई इन्धन मूल्य बढेपछि एयरलाइन्सले घरेलु तथा अन्तर्राष्ट्रिय भाडा बढाएका छन्।",
    ...
    metaDescription: "Rising aviation fuel prices force airlines to hike fares, threatening Nepal's tourism-dependent economy.",
    categoryId: CATEGORIES.economy,
  ...
  },
  {
    ...
    excerptEn: "Sudhan Gurung demands refund of rent paid for leased land near the famous lake.",
    excerptNe: "गृहमन्त्री सुधन गुरुङले फेवाताल नजिकको जग्गा भाडामा लिँदा झुक्याइएको दाबी गर्दै भाडा फिर्ता माग्नुभएको छ।",
    ...
    metaDescription: "Home Minister Sudhan Gurung denies wrongdoing in Fewa Lake land lease, says he was misled by landowners.",
    categoryId: CATEGORIES.politics,
  ...
  },
  {
    ...
    excerptEn: "Investors cheer the government's new policies and two-day weekend decision.",
    excerptNe: "नयाँ सरकारको नीति र दुई दिने बिदा निर्णयले लगानीकर्ताहरू उत्साहित भएका छन्।",
    ...
    metaDescription: "Nepal Stock Exchange gains amid positive investor sentiment following new government's economic measures.",
    categoryId: CATEGORIES.economy,
  ...
  {
    titleEn: "Stranded French National in Pashupatinath Handed Over to Immigration",
    titleNe: "पशुपतिनाथ क्षेत्रमा अलपत्र फ्रान्सेली नागरिकलाई अध्यागमनमा बुझाइयो",
    excerptEn: "Police acted swiftly after locating the foreigner in the UNESCO World Heritage site.",
    excerptNe: "प्रहरीले युनेस्को विश्व सम्पदा स्थल पशुपतिनाथमा अलपत्र फ्रान्सेली नागरिक फेला पारेर अध्यागमन विभागमा बुझाएको छ।",
    ...
    metaDescription: "Nepal Police found a stranded French national in Pashupatinath area and handed him to immigration authorities.",
    categoryId: CATEGORIES.society,
    tagIds: [TAGS.nepal, TAGS.kathmandu],
    isBreaking: false,
    isFeatured: false,
...
async function main() {
  ...
  for (let i = 0; i < articles.length; i++) {
    ...
    const baseSlug = article.titleEn
      .toLowerCase()
      .replace(/[^a-z0-9]+/g, "-")
      .replace(/^-|-$/g, "");
    ...
    console.log(`✅ Article ${i + 1}/${articles.length}: "${article.titleEn.substring(0, 40)}..."`);
    console.log(`   Slug: ${slug}`);
    console.log(`   Category ID: ${article.categoryId}`);
    console.log(`   Tags: ${article.tagIds.length}\n`);
  }
...
main()
  ...
  /**
   * 
   * run this script with: npx tsx --env-file=.env.production scripts/import-articles.ts
   */
